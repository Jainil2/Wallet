...
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:wallet/pages/waller_list.dart';
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemCount: wallet?.docs.length,
                          itemBuilder: (context, index) {
                            final doc = wallet!.docs[index];
                            return FadeInDown(
                              duration: const Duration(milliseconds: 500),
                              child: Container(
